...
echo "" | base64 -d > /tmp/sqlstatement.sql
...
mysql -e "use mysql;select * from user " |grep  -e mysql -e native -e root -e $MYSQL_USER |wc -l |grep -q ^0 && { build_ok=no ;fail_reasons=${fail_reasons}" mysql_no_searchtermss_in_mysql_user" ;  }  ;
echo ; };
